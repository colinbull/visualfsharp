...
// MVID: {4BEB28D7-4FAE-FD21-A745-0383D728EB4B}
.imagebase 0x00400000
.file alignment 0x00000200
.stackreserve 0x00100000
.subsystem 0x0003       // WINDOWS_CUI
.corflags 0x00000001    //  ILONLY
// Image base: 0x01DF0000
       ...
       extends [mscorlib]System.Object
{
                    ...
                    [mscorlib]System.Collections.IStructuralComparable
  {
            ...
            instance int32  CompareTo(object obj) cil managed
    {
      ...
      IL_0008:  call       instance int32 SteppingMatch06/Discr::CompareTo(class SteppingMatch06/Discr)
      IL_000d:  ret
    } // end of method Discr::CompareTo
            ...
            instance int32  GetHashCode() cil managed
    {
      ...
      IL_0007:  call       instance int32 SteppingMatch06/Discr::GetHashCode(class [mscorlib]System.Collections.IEqualityComparer)
      IL_000c:  ret
    } // end of method Discr::GetHashCode
            ...
            instance bool  Equals(object obj) cil managed
    {
      ...
      IL_000f:  ldarg.0
      IL_0010:  ldloc.0
      IL_0011:  call       instance bool SteppingMatch06/Discr::Equals(class SteppingMatch06/Discr)
      IL_0016:  ret
